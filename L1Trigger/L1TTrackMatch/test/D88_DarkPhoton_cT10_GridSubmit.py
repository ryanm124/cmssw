...
submit += 'queue\n'
submitName = 'D88_DarkPhoton_mH125_mGammaD20_cT10/submit01.sub'
sub1 = open(submitName,'w')
sub1.write(submit+'\n')
sub1.close() ##finish writing .sub file
nfile = 2 ##number of sample file processed per each condor job
filename = 'DarkPhoton_mH125_mGammaD20_cT_10.txt' ## location of the txt file used to help locate samples
with open(filename,'r') as f:
    ...
    while True:
        ...
        create += 'cmsRun GridL1TrackObjectNtupleMaker_cfg.py inputFiles='+input+' outputFile=/afs/cern.ch/work/r/rmccarth/private/D88_DarkPhoton_mH125_mGammaD20_cT10_NNScoresIndexFix/'+str(160*nfile)+'events_D88_HybridDisp'+str(counter1)+'.root  maxEvents='+str(160*nfile)+'\n'
        createName = 'D88_DarkPhoton_mH125_mGammaD20_cT10/submit'+str(counter1)+'.sh'
